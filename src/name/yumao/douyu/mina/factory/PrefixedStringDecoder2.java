 ...
 */
public class PrefixedStringDecoder2 extends CumulativeProtocolDecoder {
     ...
     */
    public PrefixedStringDecoder2(Charset charset, int prefixLength, int maxDataLength) {
        this.charset = charset;
        this.prefixLength = prefixLength;
        this.maxDataLength = maxDataLength;
    }

    public PrefixedStringDecoder2(Charset charset, int prefixLength) {
        this(charset, prefixLength, DEFAULT_MAX_DATA_LENGTH);
    }

    public PrefixedStringDecoder2(Charset charset) {
    ...
    protected boolean doDecode(IoSession session, IoBuffer in, ProtocolDecoderOutput out) throws Exception {
    	 System.out.print ("in.remaining : "+in.remaining());
